...
export default function CreatorPage() {
  ...
  const loadTrends = async () => {
    ...
    try {
      const r = await fetch("/api/youtube/trending?region=", { cache: "no-store" });
