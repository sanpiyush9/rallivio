...
export default async function AccountPage() {
  ...
  return <main className="account-page"><section className="account-shell">
    <div className="account-top"><Link href="/living" className="back-link">← Back to Discover</Link><span className="eyebrow">YOUR RALLIVIO PROFILE</span></div>
