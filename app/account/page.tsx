...
import { deleteAccount, logout, updateProfile } from "./actions";
  ...
  return <main className="account-page"><section className="account-shell">
    ...
    <div className="profile-form"><form action={updateProfile}>
      ...
      <div className="danger-zone">
        <div><h3>Delete account</h3><p>This permanently deletes your RALLIVIO account and profile. This cannot be undone.</p></div>
        <form action={deleteAccount} className="delete-form">
          <label>Type DELETE to confirm<input name="delete_confirmation" placeholder="DELETE" autoComplete="off" required /></label>
