  ...
  return <main className={`rv theme-${theme}`}>
    ...
    <section className="radarSection">
      <div className="radarPanel">
        ...
        {apiUsageLatestAt && <details className="discoveryAudit">
          <summary><span>ⓘ How RALLIVIO detects these signals</span><b>Explain</b></summary>
          <div className="discoveryAuditBody">
            <div><b>SOURCE</b><span>YouTube public video observations collected into RALLIVIO’s verified discovery pool.</span></div>
            <div><b>WHAT IS A SIGNAL</b><span>A video observation that passes RALLIVIO’s signal validation and ranking pipeline. It is attached to the observed video, not a claim about the whole topic or internet.</span></div>
            <div><b>WHEN CAPTURED</b><span>Each observation carries a source statistics timestamp. The page refreshes the displayed pool every 60 seconds; new source acquisition is globally gated to avoid multiplying API usage.</span></div>
            <div><b>HOW IT MOVES</b><span>Topic counts show the current verified signal pool. Topic movement is measured separately from repeated hourly view observations used for rise/fall trends.</span></div>
            <div><b>IMPORTANT</b><span>The radar is a live visualization of the current verified state. Its dots are not geographic coordinates or fabricated real-time events.</span></div>
          </div>
        </details>
