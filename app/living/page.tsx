...
const themeDefinitions = [
  { id: "nebula", name: "Midnight Aurora", short: "Midnight", desc: "violet / cyan", mode: "signature", accent: "violet" },
  { id: "aurora", name: "Aurora Flow", short: "Aurora", desc: "teal / sky", mode: "flow", accent: "cyan" },
  { id: "neon", name: "Violet Pulse", short: "Violet", desc: "violet / rose", mode: "pulse", accent: "magenta" },
  { id: "lunar", name: "Ice Glass", short: "Ice", desc: "blue / silver", mode: "calm", accent: "ice" },
] as const;
...
/* Header final geometry lock — protected columns, no overlap. */
...
.topbar nav button{flex:0 0 auto!important;white-space:nowrap!important}
.topbar nav button:nth-child(3){max-width:none!important}
