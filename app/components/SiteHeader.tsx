...
export default function SiteHeader() {
  ...
  return <header className="site-header">
    ...
    {userEmail ? <><button className="site-login" type="button" onClick={() => router.push("/account")}>{userEmail.split("@")[0]}</button><button className="site-tool" type="button" onClick={logout}>Log out</button></> : <button className="site-login" type="button" onClick={() => router.push("/login")}>Login</button>}
